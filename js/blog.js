...
(function () {
  ...
  var POSTS = [
    ...
    { cat: "Amazon", icon: "", title: "Amazon Commission Rates by Category (2026)", date: "Aug 17, 2026", read: "7 min", url: "blogs/amazon-commission-rates-by-category.html", desc: "Category-by-category breakdown — electronics, luxury, beauty, home — with current percentages and what they mean for your content." },
    ...
    { cat: "Networks", icon: "", title: "ShareASale vs CJ vs Impact: Which Pays Better?", date: "Aug 17, 2026", read: "8 min", url: "blogs/shareasale-vs-cj-vs-impact.html", desc: "Head-to-head on commission tiers, approval odds, payout thresholds, and fit vs Amazon for affiliate publishers." },
    ...
    { cat: "Link Building", icon: "", title: "Backlinks for an Affiliate Site: 30-Day Plan", date: "Aug 17, 2026", read: "8 min", url: "blogs/how-to-build-backlinks-for-affiliate-site.html", desc: "A month-by-month backlink plan for affiliate publishers — directories, guest posts, roundups, and link-worthy content." },
    ...
    { cat: "Tools", icon: "", title: "Amazon Affiliate Break-Even Calculator Guide", date: "Aug 17, 2026", read: "7 min", url: "blogs/amazon-affiliate-breakeven-calculator-guide.html", desc: "Find which products and price points actually justify your content time in 2026 with the break-even calculator." },
    { cat: "Tools", icon: "", title: "Which Price Point Pays? Break-Even Analysis", date: "Aug 17, 2026", read: "7 min", url: "blogs/price-points-breakeven-analysis.html", desc: "Comparing cheap vs expensive products — conversion, commission rate, returns, and effort — to find price points that pay." },
